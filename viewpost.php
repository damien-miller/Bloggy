...
$stmt = $db->prepare('SELECT postID, postTitle, postCont, postImage, postDate FROM posts WHERE postID = :postID');
...
<body>
    ...
    <?php
      $comd = $db->prepare("SELECT name, comment, post_id FROM comments WHERE POST_ID=".$_GET['id']." ORDER BY id DESC");
      $comd->execute();
      $comments = $comd->fetchAll();
    ?>
